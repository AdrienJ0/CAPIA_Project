"""This script is an old version of the code use in order to have filled masks (See the image 'contours_plein.jpg' in order to have more potential context)"""
...
# # print(f"CCOMP: {hierarchy}")
cv2.waitKey(0)
cv2.imwrite("contours_plein.jpg", image)
